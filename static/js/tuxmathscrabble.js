		...
		for(var idx=0;idx<2;idx++){//set the indicator
			...
			if(false){
				...
				if(window.PLAYER1=="robot"){
					...
					document.getElementById(bid).firstChild.firstChild.src="static/img/make_move_button.png";
	...
	me.make_slide_panel0=function(){
		...
		$("#start_demo").click(function(){
			if(window.RUNNING==true){
				...
				document.getElementById("start_demo_img").src="static/img/stop_demo.png";
				me.stop();
				me.resetCB();
			}
